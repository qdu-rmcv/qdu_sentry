...
{
  declare_parameter(
    "file_directory", "/home/rm/qdu-sentry/src/rm_perception/fast_lio/PCD/");
  declare_parameter("file_name", "map_1");
  declare_parameter("thre_z_min", 0.1);
  declare_parameter("thre_z_max", 0.6);
